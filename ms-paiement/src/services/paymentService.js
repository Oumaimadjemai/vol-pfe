    ...
    try {
      ...
      const payload = {
        ...
        currency: currency.toLowerCase(),
         success_url: successUrl || `${frontendUrl}/reservation-confirmation`,
         failure_url: cancelUrl || `${frontendUrl}/payment/cancel`,
        webhook_endpoint: webhookUrl || `${process.env.WEBHOOK_BASE_URL}/webhooks/chargily`,
